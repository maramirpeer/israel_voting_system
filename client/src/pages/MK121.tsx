...
import { ArrowLeft, ThumbsDown, ThumbsUp, AlertCircle, CheckCircle, Plus, FileText } from "lucide-react";
          ...
          <>
            ...
            <Card className="p-6 mb-8 bg-gradient-to-r from-blue-50 to-cyan-50 border-blue-200 text-right">
              ...
              <p className="text-slate-700 mb-4">
                ח"כ 121 יהיה אצבע נוספת בהצבעות במליאת הכנסת — אצבע הציבור הדינמית. כאשר לפחות 40,000 אזרחים משתתפים בהצבעה הציבורית בנושא, הצבעתו במליאה נקבעת בהתאם להכרעת הציבור.
              </p>
              <p className="text-slate-700 mb-4">
                בנוסף, כל 3 חודשים ינסח ח"כ 121 את הקול העונתי, במידה ויצביעו מינימום של 40,000 אזרחים לכל הפחות{" "}
              ...
              <div className="mb-4 rounded-lg border border-slate-200 bg-white p-4">
                ...
                <div className="space-y-3 text-sm leading-7 text-slate-700">
                  ...
                  <p>
                    {"\u05d4\u05d0\u05e6\u05dc\u05d4 \u05d0\u05d9\u05e0\u05d4 \u05d5\u05d9\u05ea\u05d5\u05e8 \u05e7\u05d1\u05d5\u05e2 \u05e2\u05dc \u05d4\u05e7\u05d5\u05dc. \u05d1\u05db\u05dc \u05e8\u05d2\u05e2 \u05d4\u05d0\u05d6\u05e8\u05d7 \u05d9\u05db\u05d5\u05dc \u05dc\u05d4\u05d7\u05d6\u05d9\u05e8 \u05d0\u05ea \u05e7\u05d5\u05dc\u05d5 \u05dc\u05e8\u05e9\u05d5\u05ea\u05d5 \u05d4\u05d1\u05dc\u05e2\u05d3\u05d9\u05ea \u05d5\u05dc\u05d4\u05e6\u05d1\u05d9\u05e2 \u05d1\u05e2\u05e6\u05de\u05d5."}
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="mt-8 bg-white p-6 text-right border-amber-200">
              ...
              <div className="grid gap-3 md:grid-cols-3">
                {knessetBillArchive.map((bill) => (
                  <div key={bill.id} className="rounded-lg border border-amber-100 bg-amber-50/60 p-4">
                    <Badge className="mb-3 border-amber-200 bg-amber-100 text-amber-800">עבר לכנסת</Badge>
