      ...
      <section className="relative z-10 py-20 bg-white/78 backdrop-blur-[1px]">
        <div className="container max-w-5xl text-right" dir="rtl">
          <Card className="border-[#d8c79f] bg-white p-8 shadow-sm">
            ...
            <p className="mb-6 rounded-lg border-r-4 border-[#2f7d5c] bg-[#eef6ef] p-4 text-xl font-bold leading-8 text-[#17324d]">
              ח״כ עתידי/ת יקר/ה - נבחרת בזכות אמון הציבור. האם תתחייב/י להחזיר לו חלק ממשי מהקול?
            </p>
              ...
              <div className="space-y-6 leading-8 text-slate-700">
                <div>
                  ...
                  <p className="mt-3">
                    ...
                    אחריות ציבורית, שיתוף אזרחי והחזרת כוח ההשפעה אל הציבור.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-3 font-bold text-slate-900">
                    מי שמבקש את <KolMeshutafLink className="text-[#17324d]" /> - מתחייב לפעול להשבת קולו של הציבור
