...
export default function Home() {
  ...
  useEffect(() => {
    const emailPrefix = memberLoginEmail.trim().toLowerCase();
  ...
  }, [isSignupOpen, isMemberLogin, memberLoginEmail]);
  const goToMK121Top = () => {
    setLocation("/mk121");
          ...
          <section className="container flex min-h-[calc(100vh-4rem)] flex-col justify-center gap-8 py-10">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-3xl text-xl font-semibold leading-9 text-[#52627a]">
                קול משותף מחבר אזרחים לכנסת ולממשלה בין הבחירות: הצעות חוק, שאילתות, הצבעות ישירות או האצלת הקול.
              </p>
            </div>
        ...
        <div className="container">
          <div className="mb-16 text-right">
            ...
            <div className="mx-auto mt-4 max-w-4xl space-y-4 text-lg leading-8 text-[#5f513e]">
              ...
              <div className="rounded-lg border border-[#2f7d5c]/35 bg-[#eef6ef]/78 p-5 shadow-sm">
                <p className="text-sm font-bold text-[#2f7d5c]">האצלת קול</p>
                <p className="mt-2 text-xl font-bold leading-8 text-[#17324d]">
                  לכל הקולות מקום שווה ערך: קולך יכול לפעול בעצמך או דרך אזרח/ית אחר/ת.
                </p>
                <p className="mt-2 text-base leading-7 text-[#4a3722]">
                  אם חבר/ה לא רוצה להיות נוכח/ת בערוץ המעורבות באופן פעיל, ניתן להאציל את הקול ולבחור באילו נושאים להיות נוכח/ת. בכל שלב הקול יכול לחזור לבעליו.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <form className="space-y-4" onSubmit={handleMemberLoginSubmit}>
                    <div className="relative space-y-2">
                      ...
                      <Input
                        ...
                        value={memberLoginEmail}
                        onChange={(event) => {
                          setMemberLoginEmail(event.target.value);
                          setMemberLoginMessage("");
                        }}
                        required
                      />
                      {memberLoginEmailSuggestions.length > 0 && (
