...
async function seedCitizenProposals() {
  ...
  const proposals = [
    ...
    {
      title: "חובת הצבעה של כל חברי הכנסת - לחייב בהצבעה",
      description: "הצעה לחייב כל חברי הכנסת להצביע על כל הצעה המגיעה למליאה. ביטול הצבעות שלא בנוכחות מלאה. אפשרות הצבעה מרחוק לחברים שלא יכולים להיות במליאה",
      submittedBy: "אזרח",
      status: "pending",
      votes: 0,
      cycleId: 1
